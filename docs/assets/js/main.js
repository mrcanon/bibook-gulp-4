...
(function ($) {
  ...
  var countDownTimer = function () {
    var $countDown = $('[data-countdown]'),
      countDownHtml = '<div class="countdown-item"><div class="countdown-time">%-D</div><div class="countdown-unit">Ngày</div></div>' + '<div class="countdown-item"><div class="countdown-time">%H</div><div class="countdown-unit">Giờ</div></div>' + '<div class="countdown-item"><div class="countdown-time">%M</div><div class="countdown-unit">Phút</div></div>' + '<div class="countdown-item"><div class="countdown-time">%S</div><div class="countdown-unit">Giây</div></div>';
