...
!function (e, t, o, i) {
  var n = o('html'),
    ...
    h = function (e, t) {
      ...
      return t && u(e) && (o *= s.getViewport()[t] / 100), Math.ceil(o);
    },
    g = function (e, t) {
      return h(e, t) + 'px';
    };
  o.extend(s, {
    ...
    helpers: {},
    open: function (e, t) {
      return e && (o.isPlainObject(t) || (t = {}), !1 !== s.close(!0)) ? (o.isArray(e) || (e = p(e) ? o(e).get() : [e]), o.each(e, function (n, r) {
        var a,
          l,
          c,
          d,
      ...
      }), s.opts = o.extend(!0, {}, s.defaults, t), t.keys !== i && (s.opts.keys = t.keys ? o.extend({}, s.defaults.keys, t.keys) : !1), s.group = e, s._start(s.opts.index)) : void 0;
    },
    cancel: function () {
      var e = s.coming;
    ...
    jumpto: function (e, t, o) {
      var n = s.current;
      n && (e = h(e), s.direction = t || n.direction[e >= n.index ? 'next' : 'prev'], s.router = o || 'jumpto', n.loop && (0 > e && (e = n.group.length + e % n.group.length), e %= n.group.length), n.group[e] !== i && (s.cancel(), s._start(e)));
    },
    reposition: function (e, t) {
      var i,
        n = s.current,
        r = n ? n.wrap : null;
      r && (i = s._getPosition(t), e && 'scroll' === e.type ? (delete i.position, r.stop(!0, !0).animate(i, 200)) : (r.css(i), n.pos = o.extend({}, n.dim, i)));
    },
    update: function (e) {
      var t = e && e.type,
      ...
      o && (clearTimeout(c), c = null), s.isOpen && !c && (c = setTimeout(function () {
        var i = s.current;
        i && !s.isClosing && (s.wrap.removeClass('fancybox-tmp'), (o || 'load' === t || 'resize' === t && i.autoResize) && s._setDimension(), 'scroll' === t && i.canShrink || s.reposition(e), s.trigger('onUpdate'), c = null);
      }, o && !d ? 0 : 300));
    },
    toggle: function (e) {
    ...
    unbindEvents: function () {
      s.wrap && p(s.wrap) && s.wrap.unbind('.fb'), a.unbind('.fb'), r.unbind('.fb');
    },
    bindEvents: function () {
      var e,
        t = s.current;
      t && (r.bind('orientationchange.fb' + (d ? '' : ' resize.fb') + (t.autoCenter && !t.locked ? ' scroll.fb' : ''), s.update), (e = t.keys) && a.bind('keydown.fb', function (n) {
        var r = n.which || n.keyCode,
          a = n.target || n.srcElement;
        return 27 === r && s.coming ? !1 : void (!n.ctrlKey && !n.altKey && !n.shiftKey && !n.metaKey && (!a || !a.type && !o(a).is('[contenteditable]')) && o.each(e, function (e, a) {
          return 1 < t.group.length && a[r] !== i ? (s[e](a[r]), n.preventDefault(), !1) : -1 < o.inArray(r, a) ? (s[e](), n.preventDefault(), !1) : void 0;
        }));
      }), o.fn.mousewheel && t.mouseWheel && s.wrap.bind('mousewheel.fb', function (e, i, n, r) {
        ...
        0 !== i && !l && 1 < s.group.length && !t.canShrink && (r > 0 || n > 0 ? s.prev(r > 0 ? 'down' : 'left') : (0 > r || 0 > n) && s.next(0 > r ? 'up' : 'right'), e.preventDefault());
      }));
    },
    trigger: function (e, t) {
      var i,
        n = t || s.coming || s.current;
      if (n) {
        ...
        n.helpers && o.each(n.helpers, function (t, i) {
          i && s.helpers[t] && o.isFunction(s.helpers[t][e]) && s.helpers[t][e](o.extend(!0, {}, s.helpers[t].defaults, i), n);
        }), a.trigger(e);
      }
    },
    isImage: function (e) {
    ...
    _start: function (e) {
      ...
      if (n = o.extend(!0, {}, s.opts, t), t = n.margin, i = n.padding, 'number' === o.type(t) && (n.margin = [t, t, t, t]), 'number' === o.type(i) && (n.padding = [i, i, i, i]), n.modal && o.extend(!0, n, {
        closeBtn: !1,
        closeClick: !1,
        nextClick: !1,
        arrows: !1,
      ...
      }), n.autoSize && (n.autoWidth = n.autoHeight = !0), 'auto' === n.width && (n.autoWidth = !0), 'auto' === n.height && (n.autoHeight = !0), n.group = s.group, n.index = e, s.coming = n, !1 === s.trigger('beforeLoad')) s.coming = null;else {
        if (i = n.type, t = n.href, !i) return s.coming = null, s.current && s.router && 'jumpto' !== s.router ? (s.current.index = e, s[s.router](s.direction)) : !1;
        if (s.isActive = !0, ('image' === i || 'swf' === i) && (n.autoHeight = n.autoWidth = !1, n.scrolling = 'visible'), 'image' === i && (n.aspectRatio = !0), 'iframe' === i && d && (n.scrolling = 'scroll'), n.wrap = o(n.tpl.wrap).addClass('fancybox-' + (d ? 'mobile' : 'desktop') + ' fancybox-type-' + i + ' fancybox-tmp ' + n.wrapCSS).appendTo(n.parent || 'body'), o.extend(n, {
          ...
          if (!n.content || !n.content.length) return s._error('content');
    ...
    _preloadImages: function () {
      ...
      for (t = 1; r >= t; t += 1) e = o[(i.index + t) % n], 'image' === e.type && e.href && (new Image().src = e.href);
    },
    _afterLoad: function () {
      var e,
        t,
        ...
        a = s.coming,
        l = s.current;
      if (s.hideLoading(), a && !1 !== s.isActive) if (!1 === s.trigger('afterLoad', a, l)) a.wrap.stop(!0).trigger('onReset').remove(), s.coming = null;else {
        switch (l && (s.trigger('beforeChange', l), l.wrap.stop(!0).removeClass('fancybox-opened').find('.fancybox-item, .fancybox-nav').remove()), s.unbindEvents(), e = a.content, t = a.type, i = a.scrolling, o.extend(s, {
          wrap: a.wrap,
          skin: a.skin,
          outer: a.outer,
          inner: a.inner,
          ...
          case 'ajax':
          case 'html':
            a.selector ? e = o('<div>').html(e).find(a.selector) : p(e) && (e.data('fancybox-placeholder') || e.data('fancybox-placeholder', o('<div class="fancybox-placeholder"></div>').insertAfter(e).hide()), e = e.show().detach(), a.wrap.bind('onReset', function () {
              o(this).find(e).length && e.hide().replaceAll(e.data('fancybox-placeholder')).data('fancybox-placeholder', !1);
            }));
            break;
          case 'image':
            e = a.tpl.image.replace('{href}', n);
            break;
          case 'swf':
            e = '<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="' + n + '"></param>', r = '', o.each(a.swf, function (t, o) {
              e += '<param name="' + t + '" value="' + o + '"></param>', r += ' ' + t + '="' + o + '"';
    ...
    _setDimension: function () {
      var e,
        ...
        _ = h(W[1] + W[3]),
        A = h(W[0] + W[2]);
      if (m.add(y).add(w).width('auto').height('auto').removeClass('fancybox-tmp'), W = h(y.outerWidth(!0) - y.width()), e = h(y.outerHeight(!0) - y.height()), t = _ + W, i = A + e, n = u(x) ? (p.w - t) * h(x) / 100 : x, r = u(v) ? (p.h - i) * h(v) / 100 : v, 'iframe' === b.type) {
        if (d = b.content, b.autoHeight && 1 === d.data('ready')) try {
          d[0].contentWindow.document.location && (w.width(n).height(9999), a = d.contents().find('body'), O && a.css('overflow-x', 'hidden'), r = a.outerHeight(!0));
        } catch (L) {}
      } else (b.autoWidth || b.autoHeight) && (w.addClass('fancybox-tmp'), b.autoWidth || w.width(n), b.autoHeight || w.height(r), b.autoWidth && (n = w.width()), b.autoHeight && (r = w.height()), w.removeClass('fancybox-tmp'));
      if (x = h(n), v = h(r), c = n / r, T = h(u(T) ? h(T, 'w') - t : T), k = h(u(k) ? h(k, 'w') - t : k), S = h(u(S) ? h(S, 'h') - i : S), F = h(u(F) ? h(F, 'h') - i : F), a = k, l = F, b.fitToView && (k = Math.min(p.w - t, k), F = Math.min(p.h - i, F)), t = p.w - _, A = p.h - A, b.aspectRatio ? (x > k && (x = k, v = h(x / c)), v > F && (v = F, x = h(v * c)), T > x && (x = T, v = h(x / c)), S > v && (v = S, x = h(v * c))) : (x = Math.max(T, Math.min(x, k)), b.autoHeight && 'iframe' !== b.type && (w.width(x), v = w.height()), v = Math.max(S, Math.min(v, F))), b.fitToView) if (w.width(x).height(v), m.width(x + W), p = m.width(), _ = m.height(), b.aspectRatio) for (; (p > t || _ > A) && x > T && v > S && !(19 < f++);) v = Math.max(S, Math.min(F, v - 10)), x = h(v * c), T > x && (x = T, v = h(x / c)), x > k && (x = k, v = h(x / c)), w.width(x).height(v), m.width(x + W), p = m.width(), _ = m.height();else x = Math.max(T, Math.min(x, x - (p - t))), v = Math.max(S, Math.min(v, v - (_ - A)));
      O && 'auto' === C && r > v && t > x + W + O && (x += O), w.width(x).height(v), m.width(x + W), p = m.width(), _ = m.height(), m = (p > t || _ > A) && x > T && v > S, x = b.aspectRatio ? a > x && l > v && n > x && r > v : (a > x || l > v) && (n > x || r > v), o.extend(b, {
        dim: {
          width: g(p),
          height: g(_)
        },
        ...
        skinSpace: y.height() - v
      }), !d && b.autoHeight && v > S && F > v && !x && w.height('auto');
    },
    _getPosition: function (e) {
      ...
      return t.autoCenter && t.fixed && !e && r <= o.h && n <= o.w ? i.position = 'fixed' : t.locked || (i.top += o.y, i.left += o.x), i.top = g(Math.max(i.top, i.top + (o.h - r) * t.topRatio)), i.left = g(Math.max(i.left, i.left + (o.w - n) * t.leftRatio)), i;
    },
    ...
    getOrigPosition: function () {
      var e = s.current,
        ...
        l = e.wPadding,
        c = s.getViewport();
      return !o && e.isDom && t.is(':visible') && (o = t.find('img:first'), o.length || (o = t)), p(o) ? (i = o.offset(), o.is('img') && (n = o.outerWidth(), r = o.outerHeight())) : (i.top = c.y + (c.h - r) * e.topRatio, i.left = c.x + (c.w - n) * e.leftRatio), ('fixed' === s.wrap.css('position') || e.locked) && (i.top -= c.y, i.left -= c.x), i = {
    ...
    step: function (e, t) {
      ...
      var r = i.wrapSpace,
        a = i.skinSpace;
      ('width' === n || 'height' === n) && (o = t.end === t.start ? 1 : (e - t.start) / (t.end - t.start), s.isClosing && (o = 1 - o), i = 'width' === n ? i.wPadding : i.hPadding, i = e - i, s.skin[n](h('width' === n ? i : i - r * o)), s.inner[n](h('width' === n ? i : i - r * o - a * o)));
    },
    zoomIn: function () {
      var e = s.current,
        t = e.pos,
      ...
      delete r.position, n ? (t = this.getOrigPosition(), e.openOpacity && (t.opacity = .1)) : 'fade' === i && (t.opacity = .1), s.wrap.css(t).animate(r, {
    ...
    zoomOut: function () {
      ...
      o && (i = this.getOrigPosition(), e.closeOpacity && (i.opacity = .1)), s.wrap.animate(i, {
    ...
    changeIn: function () {
      var e,
        ...
        r = s.direction;
      i.opacity = .1, 'elastic' === o && (e = 'down' === r || 'up' === r ? 'top' : 'left', 'down' === r || 'right' === r ? (i[e] = g(h(i[e]) - 200), n[e] = '+=200px') : (i[e] = g(h(i[e]) + 200), n[e] = '-=200px')), 'none' === o ? s._afterZoomIn() : s.wrap.css(i).animate(n, {
    ...
    update: function () {
      var e,
        o = '100%';
      this.overlay.width(o).height('100%'), l ? (e = Math.max(t.documentElement.offsetWidth, t.body.offsetWidth), a.width() > e && (o = a.width())) : a.width() > r.width() && (o = a.width()), this.overlay.width(o).height(a.height());
    },
    onReady: function (e, t) {
      var i = this.overlay;
      o('.fancybox-overlay').stop(!0, !0), i || this.create(e), e.locked && this.fixed && t.fixed && (i || (this.margin = a.height() > r.height() ? o('html').css('margin-right').replace('px', '') : !1), t.locked = this.overlay.append(t.wrap), t.fixed = !1), !0 === e.showEarly && this.beforeShow.apply(this, arguments);
    },
      ...
      if (o.isFunction(i) && (i = i.call(t.element, t)), f(i) && '' !== o.trim(i)) {
        switch (t = o('<div class="fancybox-title fancybox-title-' + n + '-wrap">' + i + '</div>'), n) {
          ...
          case 'over':
            ...
            break;
          default:
            n = s.skin, t.appendTo('body'), l && t.width(t.width()), t.wrapInner('<span class="child"></span>'), s.current.margin[2] += Math.abs(h(t.css('margin-bottom')));
        }
    ...
    var t,
      ...
      r = function (r) {
        var a,
          ...
          c = o(this).blur(),
          d = t;
        !r.ctrlKey && !r.altKey && !r.shiftKey && !r.metaKey && !c.is('.fancybox-wrap') && (a = e.groupAttr || 'data-fancybox-group', l = c.attr(a), l || (a = 'rel', l = c.get(0)[a]), l && '' !== l && 'nofollow' !== l && (c = n.length ? o(n) : i, c = c.filter('[' + a + '="' + l + '"]'), d = c.index(this)), e.index = d, !1 !== s.open(c, e) && r.preventDefault());
      };
    return e = e || {}, t = e.index || 0, n && !1 !== e.live ? a.undelegate(n, 'click.fb-start').delegate(n + ':not(\'.fancybox-item, .fancybox-nav\')', 'click.fb-start', r) : i.unbind('click.fb-start').bind('click.fb-start', r), this.filter('[data-fancybox-start=1]').trigger('click'), this;
  }, a.ready(function () {
    var t, r;
    if (o.scrollbarWidth === i && (o.scrollbarWidth = function () {
      var e = o('<div style="width:50px;height:50px;overflow:auto"><div/></div>').appendTo('body'),
        t = e.children(),
        t = t.innerWidth() - t.height(99).innerWidth();
      return e.remove(), t;
    }), o.support.fixedPosition === i) {
      t = o.support, r = o('<div style="position:fixed;top:20px;"></div>').appendTo('body');
    ...
    o.extend(s.defaults, {
      ...
      parent: o('body')
    }), t = o(e).width(), n.addClass('fancybox-lock-test'), r = o(e).width(), n.removeClass('fancybox-lock-test'), o('<style type=\'text/css\'>.fancybox-margin{margin-right:' + (r - t) + 'px;}</style>').appendTo('head');
  });
  ...
  t.helpers.media = {
    ...
    beforeLoad: function (t, i) {
      var n,
        ...
        l = i.href || '',
        c = !1;
      for (n in t) if (t.hasOwnProperty(n) && (r = t[n], a = l.match(r.matcher))) {
        c = r.type, s = e.extend(!0, {}, r.params, i[n] || (e.isPlainObject(t[n]) ? t[n].params : null)), l = 'function' === e.type(r.url) ? r.url.call(this, a, s, i) : o(r.url, a, s);
        break;
      }
  ...
  e.isScrollToFixed = function (t) {
  ...
  }, e.ScrollToFixed = function (t, o) {
    function i() {
      S.trigger('preUnfixed.ScrollToFixed'), d(), S.trigger('unfixed.ScrollToFixed'), O = -1, k = S.offset().top, F = S.offset().left, m.options.offsets && (F += S.offset().left - S.position().left), -1 == C && (C = F), x = S.css('position'), T = !0, -1 != m.options.bottom && (S.trigger('preFixed.ScrollToFixed'), l(), S.trigger('fixed.ScrollToFixed'));
    }
    function n() {
    ...
    function l() {
      if (!r()) {
        ...
        W.css({
          ...
          'margin-left': '0px'
        }, m.options.dontSetWidth || (cssOptions.width = S.css('width')), S.css(cssOptions), S.addClass(m.options.baseClassName), m.options.className && S.addClass(m.options.className), x = 'fixed';
      }
    }
    function c() {
      var e = n(),
      ...
      m.options.removeOffsets && (t = '', e -= k), cssOptions = {
        ...
        'margin-left': '0px',
        bottom: ''
      }, m.options.dontSetWidth || (cssOptions.width = S.css('width')), S.css(cssOptions), x = 'absolute';
    }
    function d() {
      s() || (O = -1, W.css('display', 'none'), S.css({
        'z-index': v,
        width: '',
        position: y,
        left: '',
        top: b,
        'margin-left': ''
      }), S.removeClass('fixed'), m.options.className && S.removeClass(m.options.className), x = null);
    }
    function p(e) {
      e != O && (S.css('left', F - e), O = e);
    }
    function f() {
    ...
    m.init = function () {
      m.options = e.extend({}, e.ScrollToFixed.defaultOptions, o), v = S.css('z-index'), m.$el.css('z-index', m.options.zIndex), W = e('<div />'), x = S.css('position'), y = S.css('position'), w = S.css('float'), b = S.css('top'), s() && m.$el.after(W), e(window).bind('resize.ScrollToFixed', _), e(window).bind('scroll.ScrollToFixed', A), 'ontouchmove' in window && e(window).bind('touchmove.ScrollToFixed', u), m.options.preFixed && S.bind('preFixed.ScrollToFixed', m.options.preFixed), m.options.postFixed && S.bind('postFixed.ScrollToFixed', m.options.postFixed), m.options.preUnfixed && S.bind('preUnfixed.ScrollToFixed', m.options.preUnfixed), m.options.postUnfixed && S.bind('postUnfixed.ScrollToFixed', m.options.postUnfixed), m.options.preAbsolute && S.bind('preAbsolute.ScrollToFixed', m.options.preAbsolute), m.options.postAbsolute && S.bind('postAbsolute.ScrollToFixed', m.options.postAbsolute), m.options.fixed && S.bind('fixed.ScrollToFixed', m.options.fixed), m.options.unfixed && S.bind('unfixed.ScrollToFixed', m.options.unfixed), m.options.spacerClass && W.addClass(m.options.spacerClass), S.bind('resize.ScrollToFixed', function () {
        ...
        S.trigger('preUnfixed.ScrollToFixed'), d(), S.trigger('unfixed.ScrollToFixed'), u();
      }), S.bind('detach.ScrollToFixed', function (t) {
        L(t), S.trigger('preUnfixed.ScrollToFixed'), d(), S.trigger('unfixed.ScrollToFixed'), e(window).unbind('resize.ScrollToFixed', _), e(window).unbind('scroll.ScrollToFixed', A), S.unbind('.ScrollToFixed'), W.remove(), m.$el.removeData('ScrollToFixed');
      }), _();
    }, m.init();
